...
pkgdatadir = $(datadir)/elysium
pkgincludedir = $(includedir)/elysium
pkglibdir = $(libdir)/elysium
pkglibexecdir = $(libexecdir)/elysium
...
BITCOIN_CLI_NAME = elysium-cli
BITCOIN_DAEMON_NAME = elysiumd
BITCOIN_GUI_NAME = elysium-qt
BITCOIN_TX_NAME = elysium-tx
...
COPYRIGHT_HOLDERS_FINAL = The Elysium Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Elysium Core
COPYRIGHT_YEAR = 2016
...
OTOOL64 = 
PACKAGE = elysium
PACKAGE_BUGREPORT = https://github.com/elysium-project/elysium/issues
PACKAGE_NAME = Elysium Core
PACKAGE_STRING = Elysium Core 0.13.2
PACKAGE_TARNAME = elysium
PACKAGE_URL = https://elysium.org/
...
PYTHONPATH = /root/elysium-0.13.2/depends/x86_64-w64-mingw32/share/../native/lib/python/dist-packages:/root/elysium-0.13.2/depends/x86_64-w64-mingw32/share/../native/lib/python/dist-packages:
QR_CFLAGS = 
QR_LIBS = -lqrencode
QTPLATFORM_CFLAGS = 
QTPLATFORM_LIBS = 
...
install_sh = ${SHELL} /root/elysium-0.13.2/build-aux/install-sh
